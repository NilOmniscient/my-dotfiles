...
local wpctl = require("widgets.volume.wpctl")

local widget_types = {
  icon_and_text = require("widgets.volume.subwidgets.icon-and-text"),
  icon = require("widgets.volume.subwidgets.icon"),
  arc = require("widgets.volume.subwidgets.arc"),
  horizontal_bar = require("widgets.volume.subwidgets.horizontal-bar"),
  vertical_bar = require("widgets.volume.subwidgets.vertical-bar"),
}
local volume = {}
